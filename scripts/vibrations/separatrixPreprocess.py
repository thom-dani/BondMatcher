...
threshold1.LowerThreshold = -9999999
threshold1.UpperThreshold = -0.005

### ALTERNATIVE pre-processing
### we do not crop the volume and go for a straight resample
# create a new 'Resample To Image'
#resampleToImage1 = ResampleToImage(registrationName='ResampleToImage1', Input=passArrays2)
...
# Alterative-1
#SaveData(outputFile, resampleToImage1)

# Alternative-2
#SaveData(outputFile, passArrays2)
