...
namespace ttk {
  ...
  //default name for separatrixGeometricStability

  const char DistanceToSeparatrix1Name[] = "DistanceToClosest1Separatrix"; 
  const char DistanceToSeparatrix2Name[] = "DistanceToClosest2Separatrix"; 
  const char ClosestSeparatrix1IdName[] = "Closest1SeparatrixId";
  const char ClosestSeparatrix2IdName[] = "Closest2SeparatrixId";
